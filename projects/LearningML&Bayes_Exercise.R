### "Teaching Maximum Likelihood & Bayesian Inference"
...
#99% of mammograms detect breast cancer when breast cancer is present
#2% of mammograms detect breast cancer when breast cancer IS ABSENT
